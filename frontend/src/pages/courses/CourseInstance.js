...
import { getDirectCourseInstanceActionApi } from "../../actions/api-actions/ProgramAction";
import { ADD_INFO_COURSE_DRAWER, SET_COURSE_INSTANCE_OUTSIDE, SET_EDIT_DIRECT_COURSE_INSTANCE } from "../../redux/types";
import FormDirectCourseInstance from "../../components/form-direct-course-instance/FormDirectCourseInstance";
...
export default function CourseInstance() {
  ...
  const sortList = ['programId', 'courseId', 'name']
  const [searchedObj, setSearchedObj] = useState([])
  const [page, setPage] = useState(1);
  const { directCourseInstance } = useSelector(
  ...
  const onChange = (page) => {
    dispatch(
      getDirectCourseInstanceActionApi(page, searchedObj)
    );
    setPage(page);
  };
  const handleSearch = () => {
    dispatch(getDirectCourseInstanceActionApi(page, searchedObj));
  }
  ...
  const handleReset = (dataIndex, clearFilters) => {
    ...
    dispatch(getDirectCourseInstanceActionApi(page, searchedObjUpdate));
  }
  ...
  const clearAllSearch = () => {
    dispatch(getDirectCourseInstanceActionApi(page, []))
    setSearchedObj([])
    setPage(1)
  ...
  const data = directCourseInstance?.data?.map((directCourseInstance, idx) => {
    return {
            ...
            <span
              ...
              onClick={() => {
                const action1 = {
                  ...
                  title: "EDIT PROGRAM",
                  Component: <FormDirectCourseInstance />,
                };
                ...
                const action2 = {
                  type: SET_EDIT_DIRECT_COURSE_INSTANCE,
              ...
              overlay={
                <Menu>
                  <Menu.Item
                    onClick={() => {
                      dispatch({
                        type: SET_COURSE_INSTANCE_OUTSIDE,
                        payload: record,
                      })
                    }}
                    key="1"
                  >
                    <NavLink
                      to={
                        `/program-version/${record.programVersionInfo}/course-instances/${record.courseId}/outcomes`
                      }
                    >
                      View Outcome
                    </NavLink>
                  ...
                  >
                    <NavLink
                      to={`/program-version/${record.programVersionInfo}/course-instances/${record.courseId}/Outcomes-Indicator`}
                    >
                      View Relationship Course Outcome & Indicator
                    </NavLink>
                  </Menu.Item>
                  <Menu.Item
                    onClick={() => {
                  ...
                  >
                    <NavLink
                      to={`/program-version/${record.programVersionInfo}/course-instances/${record.courseId}/Outcomes-Test`}
                    >
                      View Relationship Course Outcome & Test
                    </NavLink>
                  </Menu.Item>
                  <Menu.Item
                    onClick={() => {
                  ...
                  >
                    <NavLink
                      to={`/program-version/${record.programVersionInfo}/course-instances/${record.courseId}/course-outline`}
                    >
                      View Course Outline
                    </NavLink>
                  </Menu.Item>
                  ...
                  >
                    <NavLink
                      to={`/program-version/${record.programVersionInfo}/course-instances/${record.courseId}/assessment`}
                    >
                      View Assessment
                    </NavLink>
                  </Menu.Item>
                  ...
                  >
                    <NavLink
                      to={`/program-version/${record.programVersionInfo}/course-instances/${record.courseId}/classes`}
                    >
                      View Classes
                    </NavLink>
                  </Menu.Item>
                  ...
                  >
                    <NavLink
                      to={`/program-version/${record.programVersionInfo}/course-instances/${record.courseId}/test`}
                    >
                      View Tests
                    </NavLink>
                  </Menu.Item>
  ...
  return (
    <div className="mt-2 program">
      ...
      <div className="d-flex justify-content-center my-3">
        <Pagination
          current={page}
          total={directCourseInstance.total}
          onChange={onChange}
        />
      </div>
    </div>

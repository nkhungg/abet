...
const TableLeft = () => {
    ...
    const cancelStatTable = () => {
        dispatch(getVersionSurveyResultStatActionApi(programVersionInfo, surveyName, 'ce-hd'));
    }

    const saveStatTable = () => {
        let data = {programVersionInfo, surveyName, surveyType: 'ce-hd', selectedRowStaticArray: changedStat}
...
export default function CeHdStat() {

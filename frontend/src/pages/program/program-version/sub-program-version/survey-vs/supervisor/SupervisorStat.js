...
const TableLeft = () => {
    ...
    const cancelStatTable = () => {
        dispatch(getVersionSurveyResultStatActionApi(programVersionInfo, surveyName, 'supervisor'));
    }

    const saveStatTable = () => {
        let data = {programVersionInfo, surveyName, surveyType: 'supervisor', selectedRowStaticArray: changedStat}
...
export default function SupervisorStat() {

...
const TableLeft = () => {
    ...
    const cancelStatTable = () => {
        dispatch(getVersionSurveyResultStatActionApi(programVersionInfo, surveyName, 'committee'));
    }

    const saveStatTable = () => {
        let data = {programVersionInfo, surveyName, surveyType: 'committee', selectedRowStaticArray: changedStat}
...
export default function CommitteeStat() {

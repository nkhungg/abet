...
const TableLeft = () => {
    ...
    const cancelStatTable = () => {
        dispatch(getVersionSurveyResultStatActionApi(programVersionInfo, surveyName, 'internship'));
    }

    const saveStatTable = () => {
        let data = {programVersionInfo, surveyName, surveyType: 'internship', selectedRowStaticArray: changedStat}
...
export default function InternshipStat() {

...
const TableLeft = () => {
    ...
    const cancelStatTable = () => {
        dispatch(getVersionSurveyResultStatActionApi(programVersionInfo, surveyName, 'participant'));
    }

    const saveStatTable = () => {
        let data = {programVersionInfo, surveyName, surveyType: 'participant', selectedRowStaticArray: changedStat}
...
export default function ParticipantStat() {

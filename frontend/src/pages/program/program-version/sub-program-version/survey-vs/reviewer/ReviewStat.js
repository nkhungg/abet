...
const TableLeft = () => {
    ...
    const cancelStatTable = () => {
        dispatch(getVersionSurveyResultStatActionApi(programVersionInfo, surveyName, 'reviewer'));
    }

    const saveStatTable = () => {
        let data = {programVersionInfo, surveyName, surveyType: 'reviewer', selectedRowStaticArray: changedStat}

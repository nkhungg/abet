...
const TableLeft = () => {
    ...
    const cancelStatTable = () => {
        dispatch(getVersionSurveyResultStatActionApi(programVersionInfo, surveyName, 'member'));
    }

    const saveStatTable = () => {
        let data = {programVersionInfo, surveyName, surveyType: 'member', selectedRowStaticArray: changedStat}

...
const TableLeft = () => {
    ...
    const cancelStatTable = () => {
        dispatch(getVersionSurveyResultStatActionApi(programVersionInfo, surveyName, 'ce-supervisor'));
    }

    const saveStatTable = () => {
        let data = {programVersionInfo, surveyName, surveyType: 'ce-supervisor', selectedRowStaticArray: changedStat}
...
export default function CeSupervisorStat() {

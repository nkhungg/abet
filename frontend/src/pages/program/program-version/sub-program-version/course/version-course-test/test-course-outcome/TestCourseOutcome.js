...
import {
  ...
  SET_EDIT_VERSION_COURSE_INSTANCE_TEST_COURSE_OUTCOME,
} from "../../../../../../../redux/types";
import { getVersionCourseInstanceTestOutcomeActionApi } from "../../../../../../../actions/api-actions/ProgramAction";
import FormVersionCourseInstanceTestCourseOutcome from "../../../../../../../components/form-version-course-instance-test-course-outcome/FormVersionCourseInstanceTestCourseOutcome";
import DropdownSort2 from "../../../../../../../components/dropdown-sort/DropdownSort2";

const PAGE_SIZE = 10

export default function TestCourseOutcome() {
            ...
            <span
              ...
              onClick={() => {
                const action1 = {
                  ...
                  title: "EDIT TEST COURSE OUTCOME",
                  Component: <FormVersionCourseInstanceTestCourseOutcome />,
                };
                ...
                const action2 = {
                  type: SET_EDIT_VERSION_COURSE_INSTANCE_TEST_COURSE_OUTCOME,
      ...
      <div className="mb-3 d-flex justify-content-end align-items-center">
        ...
        <span
            onClick={() => {
              let action = {
                type: ADD_INFO_COURSE_DRAWER,
                title: "ADD NEW TEST COURSE OUTCOME",
                Component: <FormVersionCourseInstanceTestCourseOutcome />,
              };
              dispatch(action);
              const action2 = {

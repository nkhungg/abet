...
import { getCourseOutcomesInCourseOutlineActionApi } from "../../../../../../../actions/api-actions/ProgramAction";
import FormCourseOutcome from "../../../../../../../components/form-course-outcome/FormCourseOutcome";
import { Button } from 'antd';

export default function OutlineOutcomes() {
  const dispatch = useDispatch();
  const { selectedFolw, outcomesFromCourseOutline } = useSelector((state) => state.GeneralProgramReducer);

  useEffect(() => {
    dispatch(
      getCourseOutcomesInCourseOutlineActionApi(
  ...
  const data = outcomesFromCourseOutline?.data?.map((outcomeParent, idx) => {

...
@Data
@Table("course_instance_ndct")
public class CourseInsDetails {
  @Id
  private Integer id;
  ...
  @Column("hoat_dong_day_va_hoc")
  private String learningAndTeaching;
  ...
  public String toSql() throws AbetCseException {
    String sql = Utils.toSqlValue("chuong", chapter)
        ...
        + Utils.toSqlValue("hoat_dong_day_va_hoc", learningAndTeaching)
